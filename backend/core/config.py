...
class Config:
    ...
    FINAL_SEMANTIC_WEIGHT = float(os.getenv("FINAL_SEMANTIC_WEIGHT", 0.30))
    FINAL_TAG_WEIGHT = float(os.getenv("FINAL_TAG_WEIGHT", 0.25))
    FINAL_TEXT_WEIGHT = float(os.getenv("FINAL_TEXT_WEIGHT", 0.15))
    FINAL_EXPERIENCE_WEIGHT = float(os.getenv("FINAL_EXPERIENCE_WEIGHT", 0.15))
    FINAL_LOCATION_WEIGHT = float(os.getenv("FINAL_LOCATION_WEIGHT", 0.15))
    NORMALIZED_SCORE_MAX = float(os.getenv("NORMALIZED_SCORE_MAX", 75))
